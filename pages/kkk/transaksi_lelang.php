        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <!-- form start -->
                    <form role="form" method="post" action="pages/lelang/transaksi_lelang_proses.php">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="harga_akhir" name="harga_akhir" class="form-control" placeholder="Harga Akhir">
                            </div>
                            <div class="form-group">
                                <label>Jumlah</label>
