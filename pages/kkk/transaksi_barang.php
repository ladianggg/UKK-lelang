        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <!-- form start -->
                    <form role="form" method="post" action="pages/history_lelang/transaksi_barang_proses.php">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>id_lelang</label>
                                <input type="number" id="jumlah" name="jumlah" class="form-control" placeholder="Jumlah Barang">
                            </div>
                            <div class="form-group">
                                <label>Penawaran Harga</label>
                                <input type="number" id="penawaran_harga" name="penawaran_harga" class="form-control" placeholder="Penawaran Harga">
                            </div>
                        </div>
                        <!-- /.box-body -->
                            ...
                            <div class="modal-body">
                                <table id="produk" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="pilih" data-id="<?php echo $row['id_barang']; ?>">
