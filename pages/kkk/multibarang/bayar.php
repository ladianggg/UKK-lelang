<?php
// Check if the user has selected dark mode or light mode (You should get this value from your user settings).
$darkMode = false; // Set this value based on user preferences.

if (!empty($_SESSION['kantong_belanja'])) {
?>

<h4 class="<?= $darkMode ? 'dark-text' : 'light-text' ?>">Daftar Belanja Anda</h4>
<br>
<table class="table table-bordered <?= $darkMode ? 'light-table' : 'light-table' ?>">
    <tr align="center">
        <th>No</th>
        <th>Nama Barang</th>
        <th>Pembelian</th>
