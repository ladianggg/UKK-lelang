                    ...
                    <form role="form" method="post" action="pages/barang/ubah_barang_proses.php" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="harga_awal" value="<?php echo $row['harga_awal']; ?>"
                                    class="form-control" placeholder="Harga Awal" required>
                            </div>
                            <div class="form-group">
                                <label>Deskripsi Barang</label>
                                <input type="text" name="deskripsi_barang" value="<?php echo $row['deskripsi_barang']; ?>"
                                    class="form-control" placeholder="Deskripsi Barang" required>
                            </div>
                            <div class="form-group">
                                <label>Foto</label>
